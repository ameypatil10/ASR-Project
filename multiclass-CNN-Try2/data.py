...
class AudioData(Dataset):
  ...
  def __init__(self, data_csv, data_file, scalar_file=hparams.scalar_file, augment=True, transform=None, input_shape=hparams.input_shape, pre_process=None, ds_type=''):
        'Initialization'
  ...
  def __getitem__(self, index):
        ...
        if self.augment and np.random.uniform()>0.75:
